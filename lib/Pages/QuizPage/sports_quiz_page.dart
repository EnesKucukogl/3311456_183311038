...
import 'package:muffin/Pages/QuestionList/sports_question_list.dart';
import 'package:muffin/Pages/home_page.dart';

class SportsQuizPage extends StatefulWidget {
  const SportsQuizPage({Key? key}) : super(key: key);

  @override
  State<SportsQuizPage> createState() => _QuizPageState();
}

class _QuizPageState extends State<SportsQuizPage> {
  List<Question> questionList = getQuestionSports();
