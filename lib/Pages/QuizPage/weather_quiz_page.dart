...
import 'package:muffin/Pages/QuestionList/weather_question_list.dart';
...
class WeatherQuizPage extends StatefulWidget {
  ...
  @override
  State<WeatherQuizPage> createState() => _QuizPageState();
}

class _QuizPageState extends State<WeatherQuizPage> {
  List<Question> questionList = getQuestionWeather();
