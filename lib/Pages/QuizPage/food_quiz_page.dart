...
import 'package:muffin/Pages/QuestionList/food_question_list.dart';
...
class FoodQuizPage extends StatefulWidget {
  ...
  @override
  State<FoodQuizPage> createState() => _QuizPageState();
}

class _QuizPageState extends State<FoodQuizPage> {
  List<Question> questionList = getQuestionFood();
