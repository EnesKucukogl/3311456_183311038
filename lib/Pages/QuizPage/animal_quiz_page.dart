...
import 'package:muffin/Pages/QuestionList/animal_question_list.dart';
import 'package:muffin/Pages/home_page.dart';

class AnimalQuizPage extends StatefulWidget {
  const AnimalQuizPage({Key? key}) : super(key: key);

  @override
  State<AnimalQuizPage> createState() => _QuizPageState();
}

class _QuizPageState extends State<AnimalQuizPage> {
  List<Question> questionList = getQuestionAnimal();
