...
import '../QuestionList/holiday_question_list.dart';

class HolidayQuizPage extends StatefulWidget {
  const HolidayQuizPage({Key? key}) : super(key: key);

  @override
  State<HolidayQuizPage> createState() => _QuizPageState();
}

class _QuizPageState extends State<HolidayQuizPage> {
  List<Question> questionList = getQuestionHoliday();
